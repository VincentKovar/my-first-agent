...
A personal contact page built using agentic engineering during Agentics 101.



## Overview

A minimalist, single-file HTML landing page for a freelance marketing consultant, featuring a dark charcoal theme, responsive layout, and accessible markup. Built with pure HTML and embedded CSS — no frameworks or external dependencies — it includes entrance animations, a mailto-based booking CTA, and full ARIA support. Designed to be copy-paste ready and deployable as a static site.
...
- Iterations: 3 rounds of feedback
